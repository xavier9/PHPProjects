...
<h3><a href="http://ciprianmp.com/scripts/calendar/calendar_localized_366.zip" target="_blank">Download this multi-language version here</a> - <?php echo round(filesize('calendar_localized_366.zip')/1024, 2) . " Kb"; ?> (Last updated on <font color="green"><?php echo date('D, d M Y H:i',filemtime('calendar_localized_366.zip')); ?></font>)</h3>
<pre>- Credits go to <a href="mailto:ciprianmp@yahoo.com?subject=Localized%20Calendar%20Class%20feedback" target="_blank">Ciprian Murariu</a>, with the kind help of <a href="http://ciprianmp.com/plus/" target="_blank">phpMyChat-Plus</a> translators, based on <b><font color=red>3.66</font></b> version TJ's class above -</pre>
<br />
